...
public abstract class CommonDbStorage<T> {
    ...
    protected long insertInDb(String query, Object... params) {
        ...
        if (id != null) {
            ...
            log.error("Ошибка при получении ID после вставки: {}", query);
            throw new RuntimeException("Не удалось сохранить данные: ID не сгенерирован");
        }
    }
    ...
    protected boolean isExistsInDb(String query, Object... params) {
